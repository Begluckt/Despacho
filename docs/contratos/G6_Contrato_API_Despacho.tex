...
\begin{warningbox}[title={\faExclamationCircle\quad Documento de referencia}]
  Este contrato ha sido validado con los equipos de \textbf{G5 (Pedidos)}
  y \textbf{G8 (Pago Simulado y Notificaciones)}.
